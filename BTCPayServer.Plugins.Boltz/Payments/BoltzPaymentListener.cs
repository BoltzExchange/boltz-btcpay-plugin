...
) : IHostedService
{
    ...
    private readonly PaymentMethodId _onchainPaymentMethodId = PaymentTypes.CHAIN.GetPaymentMethodId("BTC");
        ...
        if (prompt is { Activated: true })
        {
            ...
            foreach (var o in paymentMethods)
            {
                ...
                try
                {
                    ...
                    var promptDetails = handler.ParsePaymentPromptDetails(paymentPrompt.Details);
