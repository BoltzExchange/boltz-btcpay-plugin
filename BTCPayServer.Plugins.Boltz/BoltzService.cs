    ...
    : EventHostedServiceBase(eventAggregator, logger)
{
    ...
    public override async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _settings = new ConcurrentDictionary<string, BoltzSettings>(
            ...
            .Where(pair => pair.Value?.Mode == BoltzMode.Standalone)
    ...
    {
        return GetSettings(storeId)?.Mode == BoltzMode.Standalone;
    }
    ...
    public BoltzSettings? GetSettings(string? storeId)
    {
        ...
        return settings?.Mode == BoltzMode.Standalone ? settings : null;
    }
    ...
    public async Task Set(string storeId, BoltzSettings? settings)
    {
        ...
        else
        {
            ...
            {
                throw new InvalidOperationException("Only standalone mode is supported");
            }
